...
public class TurtleTreasureHunt implements KeyEventDispatcher {
	...
	private void spaceBarWasPressed() {
		int tlx = Tortoise.getX();
		int tly = Tortoise.getY();
		...
		// (pirate robot, swamp, parrots, etc.) 140320
		if (tlx == (140) && tly == (320)) {
			JOptionPane.showMessageDialog(null, "got in keep out");
		}
		// 220
		// 150
if(tlx==(220) && tly==(150)){
	JOptionPane.showMessageDialog(null, "who are you going to listen to");
}
	}
